    ...
    <nav class="navbar navbar-expand-lg border-bottom border-1 border-secondary bg-body-tertiary fixed-top">
        <div class="container-fluid d-flex">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <button type="button" class="btn btn-logout  btn-danger hp" style="margin-left: 68% !important;" h><a href="../logout/index.php" class="text-decoration-none text-light"> Logout</a></button>
            </div>
        </div>
    </nav>
